...
import com.example.finalyearproject.Activity.ActiveTransactionDetail;
...
public class activeTransactionsAdapter extends RecyclerView.Adapter<activeTransactionsAdapter.ViewHolder> {

    ArrayList<Transaction> transactions;

    public activeTransactionsAdapter(ArrayList<Transaction> transactions) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.mainLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(view.getContext(), ActiveTransactionDetail.class);
