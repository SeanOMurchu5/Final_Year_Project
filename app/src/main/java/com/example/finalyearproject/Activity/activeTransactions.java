...
import com.example.finalyearproject.Adapter.activeTransactionsAdapter;
...
public class activeTransactions extends AppCompatActivity {
    ...
    activeTransactionsAdapter adapter;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        transactionHistoryRecyclerView = findViewById(R.id.activeTransactionsRecyclerView);
    ...
    public void initView(){
        ...
        adapter = new activeTransactionsAdapter(dataset);
